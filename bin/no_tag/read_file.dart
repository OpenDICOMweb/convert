...
String ivrle = 'C:/odw/test_data/mweb/ASPERA/Clean_Pixel_test_data/Sop/1.2'
    '.840.10008.5.1.4.1.1.128.1.dcm';

String badVR = "C:/odw/test_data/mweb/500 MB Studies/Samples for IROC"
    "/35196654Phase2/ST-8955934202186539155/FO-2069691498165043287.dcm";
List<String> paths = <String>[path0, path1, path2, path3, path4, path5];

String badIvrle = "C:/odw/test_data/mweb/1000+/TRAGICOMIX/TRAGICOMIX"
    "/Thorax 1CTA_THORACIC_AORTA_GATED (Adult)"
    "/A Aorta w-c  3.0  B20f  0-95%/IM-0001-0020.dcm,";

String bad6 = "C:/odw/test_data/IM-0001-0001.dcm";
String bad7 = "C:/odw/test_data/mweb/ASPERA/Clean_Pixel_test_data/Sop"
