...
// 2. reportIncrement
void main()  {
  List<String> args = ["C:/odw/test_data/mweb/ASPERA/Clean_Pixel_test_data/Sop", 'd'];
...
bool doRWRByteFile(File f,
    [bool throwOnError = true, bool fast = true]) {
  final Logger log = new Logger("doRWRByteFile", Level.error);
