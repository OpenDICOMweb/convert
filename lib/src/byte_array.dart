...
class ByteArray {
  ...
  ByteArray(Uint8List bytes, [start = 0, length])
      : length = (length == null) ? bytes.length : length,
        start = start,
        position = start,
        end = start + ((length == null) ? bytes.length : length),
        limit = start + ((length == null) ? bytes.length : length), // flush end or limit
        bytes = bytes,
        bd = bytes.buffer.asByteData() {
    //print('length=${this.length}, start=$start, end=$end');
    if ((this.start + this.length) > bytes.lengthInBytes)
  ...
  void checkRange(int offset, int unitLength, int lengthInBytes, String caller) {
   // print('offset: $offset, unitLength: $unitLength, lengthInBytes: $lengthInBytes, caller: '
   //            '$caller');
  ...
  List<int> getUint8List(int offset, int lengthInBytes) {
    ...
    return bytes.buffer.asUint8List(offset, lengthInBytes);
  }
  ...
  List<int> readUint8List(int lengthInBytes) {
    ...
    print('lenInBytes=$lengthInBytes, pos=$position, value= $value');
  ...
  List<int> getInt8List(int offset, int lengthInBytes) {
    ...
    return bytes.buffer.asInt8List(offset, lengthInBytes);
  }
  ...
  List<int> getUint16List(int offset, int lengthInBytes) {
    ...
    return bytes.buffer.asUint16List(offset, lengthInBytes);
  }
  ...
  List<int> getInt16List(int offset, int lengthInBytes) {
    ...
    return bytes.buffer.asInt16List(offset, lengthInBytes);
  }
  ...
  List<int> getUint32List(int offset, int lengthInBytes) {
    ...
    return bytes.buffer.asUint32List(offset, lengthInBytes);
  }
  ...
  List<int> getInt32List(int offset, int lengthInBytes) {
    ...
    return bytes.buffer.asInt32List(offset, lengthInBytes);
  }
  ...
  List<int> getUint64List(int offset, int lengthInBytes) {
    ...
    return bytes.buffer.asUint64List(offset, lengthInBytes);
  }
  ...
  List<int> getInt64List(int offset, int lengthInBytes) {
    ...
    return bytes.buffer.asInt64List(offset, lengthInBytes);
  }
  ...
  List<double> getFloat32List(int offset, int lengthInBytes) {
    ...
    return bytes.buffer.asFloat32List(offset, lengthInBytes);
  }
  ...
  List<double> getFloat64List(int offset, int lengthInBytes) {
    ...
    return bytes.buffer.asFloat64List(offset, lengthInBytes);
  }
