...
class EncodingParameters {
  ...
  static const kNoChangeX = const EncodingParameters(
      allowImplicitLittleEndian: true,
      allowMissingFMI: true,
      doSeparateBulkdata: false,
      bulkdataThreshold: -1,
      doConvertToNormalForm: false,
      doAddMissingFMI: false,
      doUpdateFMI: false,
      doCleanPreamble: false,
