...
class EvrByteWriter extends EvrWriter with LogWriteMixin {
  @override
  ...
  /// Creates a new [EvrByteWriter], which is decoder for Binary DICOM
  /// (application/dicom).
  EvrByteWriter(RootDataset rds, EncodingParameters eParams, int minBDLength,
