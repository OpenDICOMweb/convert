...
const Map<String, List<String>> testPaths1 = const <String, List<String>>{
  // IVR
  'C:/odw/test_data/mweb/ASPERA/Clean_Pixel_test_data/Sop/': const <String>[
    '1.2.840.10008.5.1.4.1.1.128.1.dcm',
    '1.2.840.10008.5.1.4.1.1.2.dcm',
    '1.2.840.10008.5.1.4.1.1.4.dcm',
    '1.2.840.10008.5.1.4.1.1.481.2.dcm',
    '1.2.840.10008.5.1.4.1.1.481.3.dcm',
    '1.2.840.10008.5.1.4.1.1.481.5.dcm',
    '1.2.840.10008.5.1.4.1.1.7.dcm',
    '1.2.840.10008.5.1.4.1.1.88.33.dcm'
  ]
};

const Map<String, List<String>> testMaps1 = const <String, List<String>>{
  'C:/odw/test_data/sfd/CR_and_RF/Patient_25_UGI_and_SBFT/1_DICOM_Original/':
      const <String>[
    'IM000001.dcm',
    'IM000002.dcm',
    'IM000003.dcm',
  ...
  'C:/odw/test_data/sfd/CR_and_RF/Patient_31_Skeletal_survey/1_DICOM_Original/':
      const <String>[
    'IM000002.dcm',
    'IM000003.dcm',
    'IM000004.dcm',
...
const Map<String, List<String>> badFileMap1 = const <String, List<String>>{
  'C:/odw/test_data/mweb/1000+/TRAGICOMIX/TRAGICOMIX/Thorax 1CTA_THORACIC_AORTA_GATED (Adult)/'
      'A Aorta w-c  3.0  B20f  0-95%/': const <String>['IM-0001-0020.dcm'],
  'C:/odw/test_data/mweb/ASPERA/Clean_Pixel_test_data/Sop/': const <String>[
    '1.2.840.10008.5.1.4.1.1.1.2.1.dcm',
    '1.2.840.10008.5.1.4.1.1.128.dcm',
    '1.2.840.10008.5.1.4.1.1.6.2.dcm',
    '1.2.840.10008.5.1.4.1.1.88.67.dcm',
  ...
  'C:/odw/test_data/mweb/COMUNIX_2/': const <String>[
    'IM-0001-0001.dcm',
    'IM-0001-0002.dcm',
    'IM-0001-0003.dcm',
    'IM-0001-0004.dcm',
  ...
  'C:/odw/test_data/mweb/Dicom files2/PET PETCT_WB_apc  10/Projection MIP -806/':
      const <String>[
    'IM-0001-0001.dcm',
    'IM-0001-0002.dcm',
    'IM-0001-0003.dcm',
  ...
  'C:/odw/test_data/mweb/Dicom files2/PET PETCT_WB_apc (Adult) --7 Series/mpr.cor.pet -605/':
      const <String>[
    'IM-0001-0001.dcm',
    'IM-0001-0002.dcm',
    'IM-0001-0003.dcm',
  ...
  'C:/odw/test_data/mweb/Different_SOP_Class_UIDs/': const <String>[
    'Anonymized1.2.840.10008.5.1.4.1.1.1.2.1.dcm',
    'Anonymized1.2.840.10008.5.1.4.1.1.1.2.dcm',
    'Anonymized1.2.840.10008.5.1.4.1.1.11.1.dcm',
    'Anonymized1.2.840.10008.5.1.4.1.1.3.1.dcm',
    'Anonymized1.2.840.10008.5.1.4.1.1.6.1.dcm'
  ],
  'C:/odw/test_data/mweb/Different_Transfer_UIDs/': const <String>[
    'Anonymized1.2.840.10008.1.2.4.70.dcm',
    'Anonymized1.2.840.10008.1.2.4.90.dcm'
  ],
  'C:/odw/test_data/mweb/Sop/': const <String>[
    '1.2.840.10008.5.1.4.1.1.1.2.1.dcm',
    '1.2.840.10008.5.1.4.1.1.128.dcm',
    '1.2.840.10008.5.1.4.1.1.6.2.dcm',
    '1.2.840.10008.5.1.4.1.1.88.67.dcm',
  ...
  'C:/odw/test_data/mweb/Sop-selected/': const <String>[
    '1.2.840.10008.5.1.4.1.1.1.2.1.dcm',
    '1.2.840.10008.5.1.4.1.1.128.dcm',
    '1.2.840.10008.5.1.4.1.1.6.2.dcm',
    '1.2.840.10008.5.1.4.1.1.88.67.dcm',
